...
describe("PionerV1Close Signatures Contract", function () {
  ...
  beforeEach(async function () {
    ...
    _assetHex = "0x757373746f636b2e6161706c0000000000000000000000000000000000000000" ;
    _maxDelay = 600 ;
    ...
    _cType = 1 ;
/*
    await pionerV1Oracle.deployBOraclePion( _x, _parity,_maxConfidence,_assetHex,_maxDelay,_imA,_imB,_dfA,_dfB,_expiryA,_expiryB,_timeLockB,_cType );
  ...
  it("openCloseQuote signature test", async function () {
   ...
   // console.log("balances : ",BigInt(initialBalanceAddr1)/BigInt(1e18),BigInt(initialBalanceAddr2)/BigInt(1e18));
    ...
    const bContractLength = 1;
    const _bContractId = 1;
    const bOracleLength = 1;
    const _bOracleId = 1 ;
    const value = {
      isLong: true,
      bOracleId: bOracleLength ,
    ...
    console.log("signOpenQuote : ",signOpenQuote);/*
