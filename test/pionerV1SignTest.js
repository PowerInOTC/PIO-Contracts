...
describe("PionerV1Close Signatures Contract", function () {
  ...
  beforeEach(async function () {
    ...
    pionerV1Stable = await PionerV1Stable.deploy(
      pionerV1.target,
      pionerV1Compliance.target
    );
    ...
    pionerV1Warper = await PionerV1Warper.deploy(
      pionerV1.target,
      pionerV1Compliance.target,
      pionerV1Open.target,
    ...
    await pionerV1Open
      .connect(addr2)
      .acceptQuote(_bOracleId, _acceptPrice, _backendAffiliate);
  });
  ...
  it("openCloseQuote signature test", async function () {
    ...
    await pionerV1Open
      .connect(addr2)
      .acceptQuote(_newbContractId, _acceptPrice, _backendAffiliate);
    const types3 = {
      OpenCloseQuote: [
    ...
    pionerV1Warper
      .connect(addr2)
      .warperCloseQuoteSignedAndAcceptClose(
        openCloseQuoteValue,
        signCloseQuote
      );
    ...
    console.log(
      "balances : ",
      BigInt(bob1) / BigInt(1e18),
      BigInt(bob2) / BigInt(1e18),
